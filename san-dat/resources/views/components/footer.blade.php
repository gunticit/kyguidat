    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <div class="grid grid-cols-1 md:grid-cols-4 sm:gap-10 gap-4">
            ...
            <div class="text-center md:text-left">
                ...
                <div class="flex items-center gap-3 mt-4 justify-center md:justify-start">
                    ...
                    <a href="{{ $tiktok }}" target="_blank" rel="noopener noreferrer"
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M16.6 5.82A4.278 4.278 0 0113.81 3h-3.09v12.4a2.592 2.592 0 01-2.59 2.5c-1.42 0-2.6-1.16-2.6-2.6 0-1.72 1.66-3.01 3.37-2.48V9.66c-3.45-.46-6.47 2.22-6.47 5.64 0 3.33 2.76 5.7 5.69 5.7 3.14 0 5.69-2.55 5.69-5.7V9.01a7.35 7.35 0 004.3 1.38V7.3s-1.88.09-3.51-1.48z" />
                        </svg>
                    </a>
                    @endif
                    @if($zalo)
                    <a href="https://zalo.me/{{ $zalo }}" target="_blank" rel="noopener noreferrer"
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 48 48">
                            <path
                                d="M12.5 6C8.91 6 6 8.91 6 12.5v23C6 39.09 8.91 42 12.5 42h23c3.59 0 6.5-2.91 6.5-6.5v-23C42 8.91 39.09 6 35.5 6h-23zm2.14 11h18.72c.46 0 .83.37.83.83 0 .23-.09.44-.26.59L21.6 29.5h10.9c.55 0 1 .45 1 1s-.45 1-1 1H13.78c-.46 0-.83-.37-.83-.83 0-.23.09-.44.26-.59L25.54 19H14.64c-.55 0-1-.45-1-1s.45-1 1-1z" />
                        </svg>
                    </a>
                    @endif
                </div>
            ...
            <div class="text-center md:text-left">
                ...
                <!-- Company Legal Info -->
                <div class="mb-3 md:hidden text-gray-500 text-xs leading-relaxed">
                    <p class="font-semibold text-gray-400">CÔNG TY TNHH KHO ĐẤT (KHO DAT COMPANY LIMITED)</p>
                    <p>Mã số doanh nghiệp: <span class="text-gray-400 font-medium">0319338160</span> &nbsp;|&nbsp; Đăng
                        ký lần đầu: 06/01/2026</p>
                </div>
        ...
        <div class="border-t border-navy-600 mt-8 pt-6 text-center text-gray-500 text-sm">
            <!-- Company Legal Info -->
            <div class="mb-3 hidden md:block text-gray-500 text-xs leading-relaxed">
                <p class="font-semibold text-gray-400">CÔNG TY TNHH KHO ĐẤT (KHO DAT COMPANY LIMITED)</p>
                <p>Mã số doanh nghiệp: <span class="text-gray-400 font-medium">0319338160</span> &nbsp;|&nbsp; Đăng
                    ký lần đầu: 06/01/2026</p>
            </div>
