...
<header class="bg-navy-800 border-b border-navy-600 sticky top-0 z-50" x-data="{ mobileOpen: false }">
    ...
    <div x-show="mobileOpen" x-transition:enter="transition ease-out duration-200"
        ...
        <nav class="max-w-7xl mx-auto px-4 py-4 space-y-1">
            ...
            <div class="pt-2 border-t border-navy-600 mt-2 space-y-2">
                <!-- Theme Toggle -->
                <button onclick="toggleTheme()"
                    class="flex items-center w-full px-3 py-2.5 rounded-lg text-gray-300 hover:text-green-400 hover:bg-navy-700 transition font-medium">
                    <svg id="mobile-sun-icon" class="w-5 h-5 mr-3 text-yellow-400" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <svg id="mobile-moon-icon" class="w-5 h-5 mr-3 text-blue-300 hidden" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                    </svg>
                    <span id="mobile-theme-label">Chế độ sáng</span>
                </button>
                <a href="{{ env('APP_URL_SANDAT') }}"
