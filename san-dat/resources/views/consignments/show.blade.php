                        ...
                        <div
                            ...
                            @if($residentialArea)
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span
                                        class="font-medium text-gray-200">{{ rtrim(rtrim(number_format($residentialArea, 2), '0'), '.') }}
                                        m²</span>
                                </div>
                                <span class="text-navy-500">|</span>
                            @endif
                            @if($floorArea)
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span
                                        class="font-medium text-gray-200">{{ rtrim(rtrim(number_format($floorArea, 2), '0'), '.') }}
                                        m²</span>
                                </div>
                                <span class="text-navy-500">|</span>
                            @endif
                        ...
                        <div>
                            ...
                            @php
                                ...
                                if ($price >= 1000000000) {
                                    ...
                                    $priceFormatted = $billions . ' tỷ' . ($millions > 0 ? ' ' . $millions . ' triệu' : '');
