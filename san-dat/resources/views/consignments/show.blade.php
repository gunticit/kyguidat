            ...
            <div class="lg:col-span-2">
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-gray-100 rounded-xl overflow-hidden aspect-video mb-3 shadow-lg">
                        ...
                        @else
                            <div
                                class="w-full h-full flex flex-col items-center justify-center text-gray-400 bg-gradient-to-br from-gray-100 to-gray-200">
                            ...
                            <div class="flex items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="font-bold text-gray-900">
                                        {{ $consignment['code'] ?? 'BDS-' . $consignment['id'] }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white shadow-xl rounded-xl p-6 sticky top-24 border border-gray-100">
                    ...
                    @if(isset($consignment['user']))
                        <div class="flex items-center mb-5 p-4 bg-gray-50 rounded-xl">
                            <div
                                class="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg">
                    ...
                    <div class="mt-6 pt-5 border-t border-gray-100">
                        <div class="flex justify-between text-sm text-gray-500">
                            <span>Ngày đăng:</span>
                            <span
                                class="font-medium">{{ isset($consignment['created_at']) ? \Carbon\Carbon::parse($consignment['created_at'])->format('d/m/Y') : 'N/A' }}</span>
                        </div>
                        @if(isset($consignment['updated_at']))
                            <div class="flex justify-between text-sm text-gray-500 mt-2">
                                <span>Cập nhật:</span>
                                <span
                                    class="font-medium">{{ \Carbon\Carbon::parse($consignment['updated_at'])->diffForHumans() }}</span>
                            </div>
                        @endif
                    </div>
                </div>
