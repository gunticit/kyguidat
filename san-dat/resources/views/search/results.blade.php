...
@section('content')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select name="property_type"
                                class="w-full px-3 py-2 bg-navy-700 border border-navy-600 rounded-lg focus:border-green-500 focus:outline-none text-gray-200">
                                <option value="">-- Tất cả --</option>
                                <option value="dat-nen" {{ request('property_type') == 'dat-nen' ? 'selected' : '' }}>Đất nền
                                </option>
                                <option value="dat-nong-nghiep" {{ request('property_type') == 'dat-nong-nghiep' ? 'selected' : '' }}>Đất nông nghiệp</option>
                                <option value="dat-vuon" {{ request('property_type') == 'dat-vuon' ? 'selected' : '' }}>Đất
                                    vườn</option>
                                <option value="nha-pho" {{ request('property_type') == 'nha-pho' ? 'selected' : '' }}>Nhà phố
                                </option>
                                <option value="biet-thu" {{ request('property_type') == 'biet-thu' ? 'selected' : '' }}>Biệt
                                    thự</option>
                            </select>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select name="road_type"
                                class="w-full px-3 py-2 bg-navy-700 border border-navy-600 rounded-lg focus:border-green-500 focus:outline-none text-gray-200">
                                <option value="">-- Tất cả --</option>
                                <option value="mat-tien" {{ request('road_type') == 'mat-tien' ? 'selected' : '' }}>Mặt tiền
                                    đường</option>
                                <option value="hem" {{ request('road_type') == 'hem' ? 'selected' : '' }}>Hẻm</option>
                                <option value="ngo" {{ request('road_type') == 'ngo' ? 'selected' : '' }}>Ngõ</option>
                            </select>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select name="direction"
                                ...
                                <option value="dong-nam" {{ request('direction') == 'dong-nam' ? 'selected' : '' }}>Đông Nam
                                </option>
                                <option value="dong-bac" {{ request('direction') == 'dong-bac' ? 'selected' : '' }}>Đông Bắc
                                </option>
                                <option value="tay-nam" {{ request('direction') == 'tay-nam' ? 'selected' : '' }}>Tây Nam
                                </option>
                                <option value="tay-bac" {{ request('direction') == 'tay-bac' ? 'selected' : '' }}>Tây Bắc
                                </option>
                            </select>
                        </div>
                        <div>
    ...
    <script>
        ...
        (async function loadProvinces() {
            try {
                ...
                provincesData.forEach(p => {
                    ...
                    if (p.slug === currentProvince) opt.selected = true;
        ...
        function updateWards() {
            ...
            if (!slug) { wardSelect.innerHTML = '<option value="">-- Chọn tỉnh trước --</option>'; return; }
