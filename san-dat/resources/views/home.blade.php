...
@section('content')
    ...
    <script>
        ...
        function renderPropertyCard(item) {
            ...
            if (item.has_house) gridItems += '<p style="margin:0;padding:1px 0"><span style="color:#9ca3af">Tình trạng:</span> ' + (item.has_house === 'co' || item.has_house === 'yes' ? 'Có nhà' : 'Chưa bán') + '</p>';
    ...
    <script>
        ...
        function addMarker(property) {
            ...
            if (property.has_house) popupDetails += '<p style="color:#94a3b8;font-size:12px;margin:0 0 2px"><span style="color:#6b7280">Tình trạng:</span> ' + (property.has_house === 'co' || property.has_house === 'yes' ? 'Có nhà' : 'Chưa bán') + '</p>';
