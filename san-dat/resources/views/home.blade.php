...
@section('content')
    ...
    <!-- Map Section -->
    <section class="py-16 sm:py-8 xs:py-4 bg-navy-800">
        <div class="max-w-7xl mx-auto px-4 xs:py-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl xs:text-xl font-bold text-gray-100 xs:mb-4 mb-8">Bất động sản cần bán</h2>
    ...
    @endif
    <!-- CTA Section -->
    <section class="py-16 xs:py-8 bg-gradient-to-r from-green-600 to-green-700">
