...
@section('content')
    ...
    @if(!empty($featuredProvinces) && count($featuredProvinces) > 0)
        <section class="py-12 sm:py-8 bg-navy-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <section class="py-16 sm:py-8 bg-gradient-to-r from-green-600 to-green-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <!-- Download App Button -->
            <button
                class="mx-auto mt-2 pwa-install-btn mt-4 items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl text-sm font-semibold hover:from-green-600 hover:to-green-700 transition-all shadow-lg shadow-green-500/20 hover:shadow-green-500/30"
                style="display: none;"
