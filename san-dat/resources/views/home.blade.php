...
@section('content')
    ...
    <script>
        ...
        function renderPropertyCard(item) {
            ...
            if (item.frontage_actual && item.frontage_actual !== '0' && item.frontage_actual !== '0.00') gridItems += `<p><span class="text-gray-400">Mặt tiền:</span> ${item.frontage_actual}</p>`;
            ...
            return `
                <a href="/bat-dong-san/${slug}" class="flex bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition group border border-gray-200">
                    ...
                    <div class="flex-1 p-3 md:p-4 flex flex-col justify-between min-w-0">
                        <div>
                            ...
                            <h3 class="font-bold text-blue-700 uppercase text-sm md:text-base mb-2 line-clamp-2">${item.title || 'Bất động sản'}</h3>
                        ...
                        <div class="mt-2 flex justify-start">
                            <span class="inline-flex items-center gap-1 text-xs md:text-sm font-medium text-green-600 hover:text-green-700">
                                Xem ngay
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
