...
@section('content')
    ...
    <section class="py-16" id="all-properties-section">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h2 class="text-3xl font-bold text-gray-100">Hiển thị theo vị trí gần tôi</h2>
                    <div id="locationStatus" class="flex items-center gap-2 mt-2 text-sm">
                        <span class="inline-block w-2 h-2 rounded-full bg-yellow-400 animate-pulse"></span>
                        <span class="text-gray-400">Đang xác định vị trí...</span>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateLocationStatus(status) {
            ...
            if (!el) return;
            if (status === 'active') {
                el.innerHTML = '<span class="inline-block w-2 h-2 rounded-full bg-green-400"></span><span class="text-green-400">Đang hiển thị theo khoảng cách gần bạn</span>';
            } else if (status === 'denied') {
                el.innerHTML = '<span class="inline-block w-2 h-2 rounded-full bg-gray-500"></span><span class="text-gray-500">Không lấy được vị trí — hiển thị mặc định</span>';
            } else {
                el.innerHTML = '<span class="inline-block w-2 h-2 rounded-full bg-gray-500"></span><span class="text-gray-500">Trình duyệt không hỗ trợ định vị</span>';
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', () => setTimeout(() => initGeolocation(), 500));
    </script>
