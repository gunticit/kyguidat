...
@section('content')
    ...
    <script>
        ...
        function renderPropertyCard(item) {
            ...
            return `
                                                                <a href="/bat-dong-san/${item.id}" class="bg-navy-700 rounded-lg shadow-md overflow-hidden hover:shadow-xl hover:shadow-green-500/10 transition group border border-navy-600">
            ...
            const infoContent = `
                                                                                    <div style="width: 280px; font-family: Arial, sans-serif; background: var(--navy-800); border-radius: 12px; overflow:hidden;">
                                                                                        ...
                                                                                        <div style="padding: 12px;">
                                                                                            ...
                                                                                            <a href="/bat-dong-san/${property.id}" 
