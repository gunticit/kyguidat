...
@section('content')
    ...
    <!-- Map Section -->
    <section class="py-16 sm:py-8 py-2 bg-navy-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div>
    ...
    <section class="py-16 sm:py-8 py-2" id="all-properties-section">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <script>
        ...
        function addMarker(property) {
            ...
            const infoContent = `
                                                                    <div style="width: min(80vw, 320px); font-family: Arial, sans-serif; background: var(--navy-800); border-radius: 12px; overflow:hidden;">
    ...
    @if(!empty($featuredProvinces) && count($featuredProvinces) > 0)
        <section class="sm:py-8 py-2 bg-navy-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @endif
    <!-- CTA Section -->
    <section class="py-16 sm:py-8 py-2 bg-gradient-to-r from-green-600 to-green-700">
